...
import { WorkspaceService } from "@/modules/workspace/workspace.service"; // Ensure service exists
...
export default async function DashboardPage({ params }: PageProps) {
    ...
    if (!role) {
        ...
        return (
            <div className="flex flex-col items-center justify-center h-[60vh] space-y-4">
                ...
                <p>You are not a member of {workspace.name}.</p>
    ...
    return (
        <>
            ...
            {!user.emailVerified && (
                <div className="bg-yellow-100 dark:bg-yellow-900/30 border-l-4 border-yellow-500 text-yellow-700 dark:text-yellow-400 p-4 rounded-r shadow-sm mt-4" role="alert">
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7 mt-8">
                ...
                <div className="col-span-3 rounded-xl border bg-card text-card-foreground shadow-sm p-6">
                    <h3 className="font-semibold text-lg mb-4">Your Role: <span className="capitalize text-primary">{role}</span></h3>
                    <div className="space-y-4">
                        ...
                        <div className="pt-4 border-t">
                            <p className="text-xs text-muted-foreground">Workspace ID: {workspace.id}</p>
                        </div>
                    </div>
                </div>
            </div>
